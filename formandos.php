...
<div class="wrapper">
  ...
  <h1 align="center">Formandos <?php echo date("Y"); ?></h1>
    <!-- Main content -->
    ...
    <?php
        ...
        $sql = "SELECT * FROM aluno WHERE idAno = 3 ORDER BY nome";
    ...
    ?>
      ...
      <h3>
      <?php echo $cont['nome']; ?>
        <small>RA: <?php echo $cont['ra']; ?></small><br>
        <small><?php echo $cont['email']; ?></small><br>
        <small><?php echo $cont['whatsapp']; ?></small>
      </h3>
              ...
              <script>
                ...
                window.location.href = "confirmacaoDeletarFormandos.php";
                };
              </script>
