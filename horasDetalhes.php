...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    ?>
      <h1><a href = "cadastro_completo.php?ra=<?php echo $ra ?>">
      <?php echo $cont['nome']; ?>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $sqlHorasGeralDetalhes = "SELECT * FROM horasGeralDetalhes WHERE idHorasGeral = $idHorasGeral";
                ...
                while ($contHorasGeralDetalhes = mysqli_fetch_array($resultadoHorasGeralDetalhes))
                {
                  ...
                  echo "
                    <tr>
                      ...
                      <td><a href='del_horas.php?idHorasGeralDetalhes=".$contHorasGeralDetalhes['idHorasGeralDetalhes']."&nome=".$nome2."&data2=".$contHorasGeralDetalhes['data']."&idHorasGeral=$idHorasGeral"."'>Deletar</a></td>
                    </tr>
                  ";
                  $inc++;
                }
                ...
                if($inc == 0){
                  echo '<script>
                  alert("O aluno ainda não realizou nenhum estágio") 
              ...
              <?php
                  ...
                  while ($contHorasGeral = mysqli_fetch_array($resultadoHorasGeral))
                  {
                    $horasTotal = $contHorasGeral['horasTotal'];
                  }
              ...
              <p>Total geral =  <?php echo $horasTotal;?></p>
            ...
            <div class="box-body">
              <a href="horasManual.php?ra=<?php echo $ra; ?>"><input type="button" class="btn btn-danger" value="Clique aqui para inserir horas manualmente"></a>
            </div>
            
            <div class="box-body">
            <a href="horasPeriodo.php?ra=<?php echo $ra; ?>"><input type="button" class="btn btn-primary" value="Clique aqui para ver o registro de horas por período"></a>
            </div>
